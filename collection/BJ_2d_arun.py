# -*- coding: utf-8 -*-
"""
Created on Fri Nov 10 08:52:34 2023

@author: matthew.king
"""
import BJ_2d_file as money_text
...
def main():
    ...
    money = money_text.read_file("money.txt")
    print(f"money: {money}")
    while True:
        if money <= 0:
            print("You are out of money.")
            money += int(input("Would you like to buy more chips? (y/n): "))
        bet = get_bet(money)
        if bet == 'x':
            break
    ...
    money_text.write_file("money.txt", money)
    print("Bye!")
